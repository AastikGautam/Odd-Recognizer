package W6D5StudyHallExampler;

import java.util.Scanner;

public class W6D5StudyHallExampler {
	/**
	...
	private static String executeFSM(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				// If the current character is in the set {2, 4, 6, 8}, it transitions to state 1
				...
				// If the current character is in the set {1, 3, 5, 7, 9}, it transitions to state 3
			...
			case 1: 
				...
				// If the character is in the set {1, 3, 5, 7, 9}, it transitions to state 3
				...
				// If the current character is in the set {0, 2, 4, 6, 8}, is stays in this state
			...
			case 2: 
				...
				if (currentChar == '1' || currentChar == '3' ||
						currentChar == '5' || currentChar == '7' || currentChar == '9') {
					state = 3;
					break;
				}
				
				// If the current character is in the set {2, 4, 6, 8}, is transitions to state 1
			...
			case 3:
				...
				// If the character is in the set {1, 3, 5, 7, 9}, it stays in state 3
				if (currentChar == '1' || currentChar == '3' || currentChar == '5' ||
						currentChar == '7' || currentChar == '9')
					break;
				
				// If the current character is in the set {0, 2, 4, 6, 8}, it transitions to state 1
				else if (currentChar == '0' || currentChar == '2' || currentChar == '4' ||
						currentChar == '6' || currentChar == '8') {
					state = 1;
					break;
		...
		case 0:
			...
			return "Zero is not an odd number.\n" + 
